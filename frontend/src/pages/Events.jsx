...
export default function Events() {
  ...
  useEffect(() => {
    axios.get('https://campussync-jtdq.onrender.com/api/events').then(r => setEvents(r.data))
  }, [])

  const register = async (event_id) => {
    try {
      const { data } = await axios.post('https://campussync-jtdq.onrender.com/api/registrations', { event_id },
